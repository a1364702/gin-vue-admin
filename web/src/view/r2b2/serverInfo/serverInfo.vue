  ...
  <div>
    <div class="gva-search-box">
      <el-form ref="elSearchFormRef" :inline="true" :model="searchInfo" class="demo-form-inline" @keyup.enter="onSubmit">
        ...
        <el-form-item label="服务器状态" prop="serverStatus">
          <el-select v-model="searchInfo.serverStatus" :options="serverStatusOptions" placeholder="请选择服务器状态"
                        style="flex: 1;" filterable clearable
                      />
         </el-form-item>
         <el-form-item label="服务器组" prop="serverGroup">
          <el-select v-model="searchInfo.serverGroup" :options="serverGroupOptions" placeholder="服务器组别"
                        style="flex: 1;" filterable clearable multiple
                      />
         </el-form-item>
        <el-form-item>
    ...
    <div class="gva-table-box">
      ...
      <el-table ref="multipleTable" style="width: 100%" tooltip-effect="dark" :data="tableData" row-key="ID"
        ...
        <el-table-column align="left" label="ID" prop="serverId" width="120" />

        <el-table-column align="left" label="名称" prop="serverName" width="120" />

        <el-table-column sortable align="left" label="组别" prop="serverGroup" width="120" />

        <el-table-column align="left" label="IP地址" prop="serverIp" width="120" />

        <el-table-column align="left" label="端口" prop="serverPort" width="120" />

        <el-table-column align="left" label="描述" prop="serverDesc" width="120" />
        ...
        <el-table-column align="left" label="操作" fixed="right" :min-width="appStore.operateMinWith">
          <template #default="scope">
            ...
            <el-button type="primary" link icon="edit" class="table-button"
              @click="updateServerInfoFunc(scope.row)">编辑</el-button>
    ...
    <el-drawer destroy-on-close :size="appStore.drawerSize" v-model="dialogFormVisible" :show-close="false"
      ...
      <el-form :model="formData" label-position="top" ref="elFormRef" :rules="rule" label-width="80px">
        ...
        <el-form-item label="协议类型:" prop="protocolType">
          <el-select v-model="formData.protocolType" :options=protocolTypeOptions placeholder="选择服务器的协议类型">
...
const getServerGroupFunc = async () => {
    const res = await getServerGroup()
    if (res.code === 0) {
        const serverGroup = res.data.list
        const result = []
        ...
        serverGroupOptions.value = result
    }
}
getServerGroupFunc()
